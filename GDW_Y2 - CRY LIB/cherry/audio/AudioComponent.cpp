...
//
//// loads the bank
//void cherry::AudioComponent::LoadBank(const std::string& strBankName)
//{
//	// FMOD_STUDIO_LOAD_BANK_FLAGS flags parameter removed
//	AudioEngine::GetInstance().LoadBank(strBankName);
...
//{
//	AudioEngine::GetInstance().PlayEvent(strEventName);
...
//// 	return AudioEngine::GetInstance().PlayEvent(PlaySound(strSoundName, vPosition, fVolumedB);
//// 	
//// }
//
