...
Shader::Shader(const GLchar * vertexPath, const GLchar * fragmentPath)
{
	...
	// checkCompileErrors(vertex, "VERTEX"); // alternate failure test
	...
	// checkCompileErrors(vertex, "FRAGMENT"); // alternate failure test
	...
	// print linking errors if applicable
	// checkCompileErrors(ID, "PROGRAM"); // alternate failure test
	...
	// deletion of the shaders as they're linked into our program now and no longer necessary
