...
Mesh::Mesh(Vertex* vertices, size_t numVerts, uint32_t* indices, size_t numIndices, bool wireframe)
{
...
bool Mesh::isWireframe()
{
	return this->wireframe;
}

void Mesh::enableWireframe() {
	this->wireframe = true;
}

void Mesh::disableWireframe() {
	this->wireframe = false;
}
